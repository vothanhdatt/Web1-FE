    ...
    case 1:
      return [
        <div className="flex mt-0.5 mr-1">
          <span className="star">
            <svg
              className="h-3 text-yellow-400 sm:h-6 sm:w-6 "
          ...
          <span className="star">
            <svg
              className="w-3 h-3 text-white sm:h-6 sm:w-6 "
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
    ...
    case 2:
      return [
        <div className="flex mt-0.5 mr-1">
          <span className="star">
            <svg
              className="w-3 h-3 text-yellow-400 sm:h-6 sm:w-6 "
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
...
function Comment(props) {
  ...
  const loadMore = () => {
    ...
    if (noOfElement + noOfElement > commentPost.length) {
      setCount(commentPost.length);
    } else {
      setCount(noOfElement + noOfElement);
    }
  };
  if (commentPost) {
    const slice = commentPost.slice(0, noOfElement);
    return (
      <>
        {slice.map((data) => (
        ...
        <div className="mt-3 text-center sm:mt-5">
          <button
            hidden={count == commentPost.length || commentPost.length == 0}
