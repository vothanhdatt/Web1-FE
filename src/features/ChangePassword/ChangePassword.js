...
function ChangePassword() {
    ...
    return ( <
        ...
        id = "old_password"
        name = "old_password"
        placeholder = "Your Password" {...register("old_password", {
                required: {
                    value: true,
        ...
        id = "new_password"
        name = "new_password"
        placeholder = "New Password" {...register("new_password", {
                required: {
                    value: true,
                    message: "Password is required",
                },
        ...
        placeholder = "Confirm New Password" {...register("confirm_new_password", {
                required: {
                    value: true,
        ...
        /> {
            errors.confirm_new_password && ( <
                p className = "text-red-600" > { errors.confirm_new_password.message } <
                /p>
            )
        } <
        /div> <
        ...
        /div> <
        div className = { `mt-4 bg-red-500 py-2 px-4 text-sm text-white rounded border border-green focus:outline-none focus:border-green-dark text-center` } >
        <
